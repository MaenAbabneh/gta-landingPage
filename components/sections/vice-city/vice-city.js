...
function ViceCity() {
  ...
  return (
    <div
      ref={sectionRef}
      className="min-h-dvh w-full pb-[30vh] overflow-hidden"
    >
      <div
        ref={bgRef}
        ...
        style={{ opacity: 0 }}
      />
      <div className="grid grid-gallary md:gap-10 h-full">
        <div
          ref={headRef}
          className="col-[content-start/content-end] flex flex-col md:flex-row items-center justify-center mb-15 md:mb-0 gap-0 md:gap-10"
        >
          <VisitLeonied className="w-[40vw] md:w-[25vw]" />
          <p className="text-balance text-center md:text-start max-w-80 md:max-w-70 text-xl xl:text-2xl font-black font-round text-gta-white">
        ...
        <button
          ...
          className="col-[content-start/content-end] p-2 md:p-0 aspect-[3/2] relative group shadow-[0_0_0_0_rgba(0,0,0,0)] hover:shadow-[0_8px_100px_10px_rgba(0,0,0,0.2)] transition-all duration-500 ease-in-out cursor-pointer  "
        >
          ...
          <div className="relative md:absolute bottom-[-7%] md:bottom-[7%] left-1/2 -translate-x-1/2 rounded-full button-vicecity  group-hover:scale-[1.0195] group-hover:bg-gta-yellow transition-transform duration-500 flex items-center justify-center bg-gta-white font-semibold font-round z-10 ease-in-out">
            Explore Vice City
          </div>
        </button>
      </div>

  ...
  useGSAP(
    () => {
      ...
      mm.add(
        ...
        (ctx) => {
          let { isDesktop, isMobile } = ctx.conditions;
          if (!videoSrc) return;
          ...
          if (rightSideRef.current && sectionRef.current && isDesktop) {
            gsap.fromTo(
          ...
          if (sectionRef.current) {
            gsap.to(sectionRef.current, {
              ...
              scrollTrigger: {
                trigger: sectionRef.current,
                start: "bottom bottom",
                end: isDesktop ? "bottom top" : "bottom top-=80%",
                scrub: true,
                invalidateOnRefresh: true,
          ...
          const setupAnimation = () => {
            ...
            mainTl.to(
              textRef.current,
              { opacity: 1, y: isDesktop ? 0 : -1, duration: 0.2 },
              0.2
            );
